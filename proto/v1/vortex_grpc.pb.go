...
const (
	Greeter_SayHello_FullMethodName      = "/sayHello.Greeter/SayHello"
	Greeter_SayHelloAgain_FullMethodName = "/sayHello.Greeter/SayHelloAgain"
)
